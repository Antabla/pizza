...
function getConnection() {
	...
	global $db_pizza_db_Url, $db_pizza_db_User, $db_pizza_db_Pass, $db_pizza_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_pizza_db_Url.";dbname=".$db_pizza_db_DbName, $db_pizza_db_User, $db_pizza_db_Pass);
